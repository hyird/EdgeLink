...
| http.listen_port | uint16 | 443 | 监听端口 |
| http.enable_tls | bool | true | 启用 TLS |
...
| relay.listen_port | uint16 | 443 | 监听端口 |
| relay.tls.enabled | bool | true | 启用 TLS |
...
| stun.secondary_ip | string | "" | 第二 IP (NAT 检测) |
