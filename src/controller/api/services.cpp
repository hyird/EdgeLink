...
// Note: Types like RelayInfo, STUNInfo, PeerInfo, RouteInfo, ConfigPayload,
// ConfigUpdatePayload, Endpoint, EndpointType are already imported from
// edgelink::wire:: in services.hpp
