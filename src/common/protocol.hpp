...
// Wire protocol types are in a separate namespace to avoid conflicts with
...
// Re-export commonly used types to edgelink:: namespace for backward compatibility
// with code that doesn't need proto types
using wire::PROTOCOL_VERSION;
using wire::MessageType;
using wire::FrameType;
using wire::message_type_to_string;

// Namespace aliases (can't use 'using' for namespaces)
namespace CryptoConstants = wire::CryptoConstants;
...
using wire::X25519PrivateKey;
using wire::Ed25519PublicKey;
using wire::Ed25519PrivateKey;
using wire::SessionKey;
using wire::Nonce;
using wire::AuthTag;
...
// to avoid conflicts with proto-generated types. Use wire:: prefix or proto types.
